...
const TOOLS = [
  ...
  },
  {
    ...
    description: "Search German TSO grid codes (VDE-AR-N), Redispatch 2.0 rules, and grid development plan requirements.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Search BNetzA Beschlusskammer decisions on network tariffs, revenue caps, market rules, and enforcement.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query" },
...
const SearchRegulationsArgs = z.object({
  ...
  regulator: z.enum(["bnetza", "bmwk", "bfe"]).optional(),
  type: z.enum(["gesetz", "verordnung", "verwaltungsvorschrift", "leitfaden"]).optional(),

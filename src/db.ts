/**
 * SQLite database access layer for the German Energy Regulation MCP server.
 *
 * Schema covers four German energy regulators:
 *   - regulations      — BNetzA Verordnungen, BMWK Gesetze/Leitfaden, BfE nuclear safety rules
 *   - grid_codes       — German TSO technical regulations (VDE-AR-N), Redispatch 2.0
 *   - decisions        — BNetzA Beschlusskammer decisions, revenue caps, market rules
 *
